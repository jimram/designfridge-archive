...
(function($){
    ...
    $.fn.slide.defaults = {
        ...
        speed: [300, 5000000],          // first value: speed of slideffect, second value: pause between slides (when loop is active)
        autoload: [1, 5000],          // first value: if TRUE, auto-slides to #element set in url, second value: autoslide delay
        loop: [1, 9000],                // first value: TRUE or FALSE, second value: loop interrupt at user input or alternate loop speed
        ...
        alignment: 'vertical'      // layer alignment
    };
